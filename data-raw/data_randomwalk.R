## code to prepare `data_randomwalk` dataset goes here
periods = c(1100)
# parameters for c
...
data_randomwalk = data.frame(Date=Sys.Date()-days(length(simulation$y):1),y=simulation$y,x=simulation$x,c=simulation$c)

usethis::use_data(data_randomwalk, overwrite = TRUE)
